      ...
      >
        ...
        <div className="hero-content justify-start">
          <div className="max-w-md">
            ...
            <h2 className="mb-5 text-5xl font-bold">Top Trending Headphone 2023</h2>
            <h3 className="mb-5 font-semibold">Starting at <span className="text-red-500 font-bold text-5xl">$309.00</span></h3>
